defmodule RodarFeel.Parser do
  ...
  ## Examples
      ...
      iex> RodarFeel.Parser.parse("1 + 2")
      {:ok, {:binop, :+, {:literal, 1}, {:literal, 2}}}

      iex> RodarFeel.Parser.parse("true and false")
      {:ok, {:binop, :and, {:literal, true}, {:literal, false}}}

      iex> RodarFeel.Parser.parse("null")
      {:ok, {:literal, nil}}
  ...
  ## Examples
      ...
      iex> RodarFeel.Parser.parse("42")
      {:ok, {:literal, 42}}

      iex> RodarFeel.Parser.parse("x + 1")
